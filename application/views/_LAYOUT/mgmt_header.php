...
<head>
    ...
    <link href="<?=site_url()?>static/lib/admin/plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css"/>
    <link href="<?=site_url()?>static/lib/admin/plugins/select2/select2.min.css" rel="stylesheet" type="text/css" />
    <link href="<?=site_url()?>static/lib/admin/css/AdminLTE.min.css" rel="stylesheet" type="text/css"/>
    <link href="<?=site_url()?>static/lib/admin/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css"/>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?= site_url('/home/index') ?>" class="logo">
            <span class="logo-lg"><b>B-TRADING</b></span>
        </a>
